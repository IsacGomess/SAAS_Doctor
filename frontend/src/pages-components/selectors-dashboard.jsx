...
export function SelectorsDashboard() {
    ...
    return (
        <>
        <div className="icone mt-3 d-flex justify-content-center " style={{backgroundColor:'#FFFFFF'}} ><i class="bi bi-lungs"></i><p className="med">MED</p></div>
        <div className="position-btn bg-white d-flex justify-content-start flex-column align-items-center">
            <NavLink to="/dashboard"  className={({isActive}) => `btn btn-color-defaut m-1  fs-5 ${isActive ? 'activo': ''}`}>
            ...
            <NavLink to="/pacientes"  className={({isActive}) => `btn btn-color-defaut m-2  fs-5 ${isActive ? 'activo': ''}`}  >
